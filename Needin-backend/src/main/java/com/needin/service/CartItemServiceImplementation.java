...
import com.needin.exception.CartItemException;
...
import com.needin.repository.CartItemRepository;
import com.needin.repository.CartRepository;
...
public class CartItemServiceImplementation implements CartItemService {
	...
	@Override
	public CartItem isCartItemExist(Cart cart, Product product, String time, Long userId) {
		
		CartItem cartItem=cartItemRepository.isCartItemExist(cart, product, time, userId);
